...
resource "oci_core_network_security_group" "nsx_vtep" {
  compartment_id            = var.compartment_id
  vcn_id                    = var.vcn_id
  display_name              = "nsx-vtep-nsg"
...
#######################################
#Rules based on OCVS hardening best practices - https://docs.oracle.com/en-us/iaas/Content/VMware/Reference/ocvssecurityrules.htm
resource oci_core_network_security_group_security_rule nsx_vtep_vlan_nsg_hardened_rule_1 {
  description               = "Allow all egress traffic"
  destination               = local.anywhere
  destination_type          = "CIDR_BLOCK"
  direction                 = "EGRESS"
  network_security_group_id = oci_core_network_security_group.nsx_vtep[0].id
  protocol                  = "all"
  source_type = ""
  stateless   = "false"
...
resource oci_core_network_security_group_security_rule nsx_vtep_vlan_nsg_hardened_rule_2 {
...
resource oci_core_network_security_group_security_rule nsx_vtep_vlan_nsg_hardened_rule_3 {
...
resource oci_core_network_security_group_security_rule nsx_vtep_vlan_nsg_hardened_rule_4 {
